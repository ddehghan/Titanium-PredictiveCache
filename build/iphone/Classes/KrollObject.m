...
//@interface DownloadMultipleFilesObject : NSObject
//@end

@interface DownloadMultipleFilesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DownloadMultipleFilesObject class]])
		{
			for (NSString *key in [[(DownloadMultipleFilesObject*)o modules] allKeys])
			{
