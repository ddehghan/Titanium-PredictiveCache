...
// in simulator we redefine to format for DownloadMultipleFiles Developer console
...
{\
	NSString * exceptionName = [@"org.downloadmultiplefiles." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.downloadmultiplefiles";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIDownloadMultipleFilesNativeItemNone = -1, 
	UIDownloadMultipleFilesNativeItemSpinner = -2,
	UIDownloadMultipleFilesNativeItemProgressBar = -3,
	
	UIDownloadMultipleFilesNativeItemSlider = -4,
	UIDownloadMultipleFilesNativeItemSwitch = -5,
	UIDownloadMultipleFilesNativeItemMultiButton = -6,
	UIDownloadMultipleFilesNativeItemSegmented = -7,
	
	UIDownloadMultipleFilesNativeItemTextView = -8,
	UIDownloadMultipleFilesNativeItemTextField = -9,
	UIDownloadMultipleFilesNativeItemSearchBar = -10,
	
	UIDownloadMultipleFilesNativeItemPicker = -11,
	UIDownloadMultipleFilesNativeItemDatePicker = -12,
	
	UIDownloadMultipleFilesNativeItemInfoLight = -13,
	UIDownloadMultipleFilesNativeItemInfoDark = -14,
	
	UIDownloadMultipleFilesNativeItemDisclosure = -15,
	
	UIDownloadMultipleFilesNativeItemContactAdd = -16
};
